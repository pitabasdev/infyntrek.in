  ...
  return (
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          <div className="flex items-center gap-2 rounded-full border border-blue-500 bg-blue-100 px-4 py-1 text-sm font-medium text-blue-700 dark:bg-blue-950 dark:text-blue-300">
            <BadgeCheck size={16} />
